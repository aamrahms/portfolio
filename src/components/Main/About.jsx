        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Aamrah and I am a full stack developer.'
                    />
                </h4>
                <p> 
                    <FormattedMessage
                ...
                <ul>
                    ...
                    <li>
                        <p><span>Email:</span>   aamrah.ams@gmail.com  </p>
                    </li>
                    <li>
                        <p>
                            <span>
                              ...
                              Non Resident Indian, Born and Raised in Saudi Arabia 
                        </p>
                    </li>
                    <li>
                        <p>
                ...
                <div className="skill">
                    ...
                    {/* <div>
                        <img alt="pmi" className="icons-skils" src={img(`./pmi1.png`)} />
                        <h5>Philip Morris International</h5>
                    </div>
                    <div>
                        <img alt="kelloggs" className="icons-skils" src={img(`./kelloggs.png`)} />
                        <h5>Kelloggs</h5>
                    </div>
                    <div>
                        <img alt="barminco" className="icons-skils" src={img(`./Barminco.svg`)} />
                        <h5>Barminco</h5>
                    </div> */}
                    <div>
